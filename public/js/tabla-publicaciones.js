  ...
  publicaciones.forEach((publicacion) => {
    registros += `
            <tr>
                ...
                <td>${publicacion.firma_autor}</td>
                <td>
                    <a href="/admin/editar-publicacion/${
                      publicacion.id
                    }" class="btn btn-sm btn-warning">Editar</a>
                    <button class="btn btn-danger btn-sm btn-eliminar" onclick=eliminarPublicacion(${
                      publicacion.id
                    }) id="${publicacion.id}">Eliminar</button>
                </td>
        `;
  });
